...
class Theme : ObservableObject {
   ...
   private var primaryBackgroundDarkModeUIColor = UIColor(red: 24 / 255.0, green: 25 / 255.0, blue: 47 / 255.0, alpha: 1)
   private var primaryBackgroundLightModeUIColor = UIColor(red: 24 / 255.0, green: 25 / 255.0, blue: 47 / 255.0, alpha: 1)
   private var secondaryBackgroundDarkModeUIColor = UIColor(red: 29 / 255.0, green: 33 / 255.0, blue: 61 / 255.0, alpha: 1)
   private var secondaryBackgroundLightModeUIColor = UIColor(red: 29 / 255.0, green: 33 / 255.0, blue: 61 / 255.0, alpha: 1)
